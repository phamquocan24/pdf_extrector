...
echo Starting Python service on port 8005...
...
echo - Python Service: http://localhost:8005
:: Đảm bảo các lệnh khởi động dịch vụ AI sử dụng port 8005 nếu có tham chiếu đến 8001
